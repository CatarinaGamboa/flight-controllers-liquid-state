...
public class ListPhotos {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(com.liquidjava.flightcontrollers.examples.eval_camera_2.ListPhotos.class);

    public static void main(java.lang.String[] args) {
        com.liquidjava.flightcontrollers.examples.eval_camera_2.ListPhotos.logger.debug("Starting example: taking and listing photos...");
