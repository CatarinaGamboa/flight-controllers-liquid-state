...
public class RunMission {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(com.liquidjava.flightcontrollers.examples.example1.RunMission.class);

    public static void main(java.lang.String[] args) {
        com.liquidjava.flightcontrollers.examples.example1.RunMission.logger.debug("Starting example: mission...");
        ...
        com.liquidjava.flightcontrollers.examples.example1.RunMission.logger.debug(("flight mode: " + flightmode));
        java.util.List<io.mavsdk.mission.Mission.MissionItem> cycle = new java.util.ArrayList<>();
        cycle.add(com.liquidjava.flightcontrollers.examples.example1.RunMission.generateMissionItem(47.39803986, 8.54557254));
        cycle.add(com.liquidjava.flightcontrollers.examples.example1.RunMission.generateMissionItem(47.39803622236247, 8.545014643942551));
        cycle.add(com.liquidjava.flightcontrollers.examples.example1.RunMission.generateMissionItem(47.397825620791885, 8.545009283016327));
        cycle.add(com.liquidjava.flightcontrollers.examples.example1.RunMission.generateMissionItem(47.39783288, 8.545594));
        ...
        com.liquidjava.flightcontrollers.examples.example1.RunMission.logger.debug("Upload succeeded");
        mission.downloadMission();
        com.liquidjava.flightcontrollers.examples.example1.RunMission.logger.debug("Downloading mission");
        com.liquidjava.flightcontrollers.examples.example1.RunMission.logger.debug("Mission downloaded");
    }
